...
st.set_page_config(
    page_title="Nayab's Disaster Predictor",
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={
        'Get Help': 'https://github.com/Nayab-Gauhar',
        'Report a bug': "https://github.com/Nayab-Gauhar",
        'About': "Enhanced Disaster AI Predictor v2.0 .It is Developed and created by Nayab Gauhar"
    }
)
...
def main():
    ...
    st.markdown("<h2 style='color: #3B82F6;'>Enhanced Disaster AI Predictor by Nayab Gauhar</h2>", unsafe_allow_html=True)
    ...
    try:
        with st.sidebar:
            ...
            location_name = st.text_input("Enter Location", "Los Angeles, CA")
